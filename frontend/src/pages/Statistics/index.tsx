...
const Statistics: React.FC = () => {
  ...
  const handleExportChart = (ref: React.RefObject<EChartsReact | null>, name: string) => {
  ...
  return (
    <div>
      ...
      <Row gutter={[16, 16]}>
        <Col span={24}>
          <Card><EChartsReact echarts={echarts} ref={chartRef1} option={productionOption} style={{ height: 300 }} /></Card>
        </Col>
        <Col span={12}>
          <Card><EChartsReact echarts={echarts} ref={chartRef2} option={yieldOption} style={{ height: 300 }} /></Card>
        </Col>
        <Col span={12}>
          <Card><EChartsReact echarts={echarts} ref={chartRef3} option={cycleTimeOption} style={{ height: 300 }} /></Card>
        </Col>
      </Row>
    </div>
  );
